...
export const WIREGUARD_ACCESS_PATH = 'wireguard-access';

export const USER_INTERFACE_PATH = 'user-interface';
...
export const USER_SETTINGS_USER_INTERFACE_PATH = `/${USER_SETTINGS_PATH}/${USER_INTERFACE_PATH}`;

export const USER_SETTINGS_WIREGUARD_ACCESS_PATH = `/${USER_SETTINGS_PATH}/${WIREGUARD_ACCESS_PATH}`;

export const PARENT_CHILD_PAIRING_PATH = 'parent-child-pairing';

export const USER_SETTINGS_PARENT_CHILD_PAIRING_PATH = `/${USER_SETTINGS_PATH}/${PARENT_CHILD_PAIRING_PATH}`;
